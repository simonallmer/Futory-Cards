const cardData = [
    ...
    { number: '057', name: 'Chrona', cost: '', rarity: '6', type: 'Creature', set: 'Duality', location: 'C1', description: 'When Chrona enters the Creature Zone, you may redistribute its Health Points between Strength and Resistance.', health: '2', strength: '2', resistance: '2' },
    ...
    { number: '060', name: 'Aromeas', cost: 'GGG', rarity: '6', type: 'Creature', set: 'Duality', location: 'C4', description: 'Aromeas Health Points become half of the Time Points of your active Time Die upon entering the Creature Zone.', health: 'X', strength: 'X', resistance: 'X' },
    { number: '061', name: 'Masiota', cost: 'FFL', rarity: '6', type: 'Creature', set: 'Duality', location: 'C5', description: "Instead of discarding, you may choose to deactivate Masiota. When you reactivate him in the next turn, reduce Masiota's Health Points by 1 for each time you have used this effect.", health: '3', strength: '3', resistance: '3' },
    ...
    { number: '063', name: 'Namandi', cost: '', rarity: '3', type: 'Creature', set: 'Duality', location: 'C7', description: 'Namandi gains +1 Strength for each Non-Steam Card you discard while attacking.', health: '3', strength: '3', resistance: '3' },
    { number: '064', name: 'Aqualon', cost: 'GGGLL', rarity: '3', type: 'Creature', set: 'Duality', location: 'C8', description: 'After Aqualon attacks and is discarded, you may shuffle your History Pile and Future Pile into a new Future Pile.', health: '6', strength: '6', resistance: '6' },
